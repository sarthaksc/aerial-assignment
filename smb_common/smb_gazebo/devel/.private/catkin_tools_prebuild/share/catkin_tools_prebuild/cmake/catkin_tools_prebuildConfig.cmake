...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /home/sarthak/test/smb_common/smb_gazebo/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /home/sarthak/test/smb_common/smb_gazebo/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /home/sarthak/test/smb_common/smb_gazebo/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sarthak/test/smb_common/smb_gazebo/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sarthak/test/smb_common/smb_gazebo/devel/.private/catkin_tools_prebuild/lib;/home/sarthak/test/smb_ws/devel/lib;/home/sarthak/rotors_ws/devel/lib;/home/sarthak/tutorial_ws/devel/lib;/opt/ros/noetic/lib)
